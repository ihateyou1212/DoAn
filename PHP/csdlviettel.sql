...
--
-- Máy chủ: 127.0.0.1
-- Thời gian đã tạo: Th12 05, 2016 lúc 05:47 CH
...
--
CREATE DATABASE IF NOT EXISTS `dbviettel` DEFAULT CHARACTER SET utf8 COLLATE utf8_unicode_ci;
USE `dbviettel`;
...
-- Cơ sở dữ liệu: `hope`
--
CREATE DATABASE IF NOT EXISTS `hope` DEFAULT CHARACTER SET latin1 COLLATE latin1_swedish_ci;
USE `hope`;
--
-- Cơ sở dữ liệu: `test2`
--
...
CREATE TABLE `albums` (
  ...
  `album_name` varchar(150) COLLATE utf8_unicode_ci DEFAULT NULL
...
CREATE TABLE `artists` (
  ...
  `artist_name` varchar(150) COLLATE utf8_unicode_ci DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci;
